...
import { Send, Activity, Loader2, Check, Sparkles, MessageSquare } from 'lucide-react';
    ...
    <div className="flex flex-col gap-6 animate-slide-in" style={{ maxWidth: '600px' }}>
      ...
      <div className="glass-panel" style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        <div className="flex align-center gap-3" style={{ borderBottom: '1px solid var(--border-glass)', paddingBottom: '12px' }}>
          ...
          <div style={{ flex: 1 }}>
            <h3 style={{ fontSize: '0.9rem', color: 'white' }}>Datadog Integration & Infrastructure Config</h3>
            <p className="text-gray-500" style={{ fontSize: '0.7rem' }}>API credentials, Kubernetes context, and log fetching configuration</p>
          </div>
          <span style={{ 
            padding: '3px 8px', 
            borderRadius: '4px', 
            ...
            background: deploymentMode === 'production' ? 'rgba(16,185,129,0.1)' : 'rgba(245,158,11,0.1)',
            color: deploymentMode === 'production' ? 'var(--color-success)' : 'var(--color-warning)',
            border: `1px solid ${deploymentMode === 'production' ? 'rgba(16,185,129,0.3)' : 'rgba(245,158,11,0.3)'}`
          }}>
            {deploymentMode} mode
          </span>
        </div>
        ...
        <div className="flex justify-end gap-2">
          <button onClick={saveDatadogConfig} className="btn-neon text-xs">
